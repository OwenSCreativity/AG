...
<div class="gaaTab">
  ...
  <button class="gaaTablinks" onclick="openCity(event, 'TLink')" id="defaultOpen">T-Link</button>
</div>
<div id="TLink" class="gaaC">
<div class="gaaTab">
  <button class="gaaTablinks" onclick="openCity(event, 'T1stLink')" >T1stLink</button>
  <button class="gaaTablinks" onclick="rt33()">T2ndLink</button>
</div>

</div>
<div id="T1stLink" class="gaaC">
<?php
// define variables and set to empty values
$t1 = "";

if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $t1 = t1stlink($_POST["t1"]);
 
}

function t1stlink($data) {
...
<form method="post" action="<?php echo ($_SERVER["PHP_SELF"]);?>">  
  <textarea name="t1" style="width:100%; height:50vh;"></textarea>
 <br><br><br>
  <input type="submit" name="submitt1" value="Submit">  
</form>
...
<?php
$myfilet1 = fopen("t1stlink.php", "w") or die("Unable to open file!");
fwrite($myfilet1, $t1);
fclose($myfilet1);
?>
